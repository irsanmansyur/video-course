    ...
    <div class="container container-signup animated fadeIn">
      ...
      <form method="post">
        <div class="login-form">
          ...
          <?= form_error("passwordsignin", "<div class='text-danger pl-2'>", "</div>"); ?>
          ...
          <div class="form-group form-floating-label my-2 mt-5">
            <span class="text-dark">Do You have Code Referal..? Insert Here / Empty or not</span>
            <input id="codeReferal" name="codeReferal" value="<?= set_value("codeReferal"); ?>" class="form-control input-border-bottom">
            <label for="codeReferal" class="placeholder">Kode Referal</label>
